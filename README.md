...
<img src="https://github.com/EkimovP/EkimovP/assets/125445428/4f55bd44-bed0-4cb5-b8d9-8512c903f424" align="right" width=500>
...
<!---------------------------------------------------------------------------------->
<h2 align="center"> Дипломная работа бакалавриата </h2> 
<!---------------------------------------------------------------------------------->
...
акустических волн, распределения по массам и энергиям элементарных частиц и др.<br><br>
...
2) Генерация модулированного ФМ-2 сигнала. 
3) Добавление аддитивного белого гауссовского шума. 
4) Построение спектрограммы.
5) Выбор алгоритма обнаружения.
6) Построение графиков отношения энергий и вероятности правильных обнаружений в зависимости от порога.
<img src="https://github.com/EkimovP/EkimovP/assets/125445428/fe32b706-8ddf-462f-b5ec-71bc498b2770" align="right" width=250>
По результатам моделирования был сделан вывод о том, что алгоритм быстрого преобразования Фурье дает лучший 
результат при более малом отношении сигнал/шум, чем корреляционный спектральный анализ. Также можно сделать 
выводы о том, что нелинейные методы дают более выраженный график отношения энергий и при этом могут работать 
при значении близком к единице. Но по сравнению с линейными методами они требуют более высокого отношения сигнал/шум.
<!-------------------------------------------------------------------------------------------------------------------->
