...
<!---------------------------------------------------------------------------------->
<h2 align="center"> Дипломная работа бакалавриата на языке Python</h2> 
<!---------------------------------------------------------------------------------->
...
задачи была разработана программа на языке Python, в которой были применены линейные (классические) и нелинейные методы 
